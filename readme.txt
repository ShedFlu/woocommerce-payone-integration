...
* Fixed discount calculation by removing tax from total discount

== 2.9.1 ==

Bugfixes

* Fixed deprecated nullable parameter warning in get_article_list_for_transaction_from_refund method
